...
public class MplCoreTransferProgram {
    public static TransactionInstruction createV1(
        ...
        metas.add(new AccountMeta(PK_MPL_CORE, false, false)); // 5: system program
        metas.add(new AccountMeta(PK_MPL_CORE, false, false));  // 6: log wrapper

        byte[] data = new byte[] { 0x0E, 0x00 };
